          ...
          child: Stack(
            ...
            children: [
              ...
              appCtrl.isTheme ?  SvgPicture.asset(
                ...
                height: Sizes.s100,
                colorFilter: ColorFilter.mode(appCtrl.appTheme.textColor, BlendMode.srcIn),
                fit: BoxFit.fill,
                ...
                Align(
                    ...
                    child: Column(children: [
                      ...
                      Row(
                          ...
                          children: [
                        SvgPicture.asset(svgAssets.user,colorFilter: ColorFilter.mode(
                            appCtrl.isTheme
                  ...
                  child: Column(children: [
                    ...
                    Text(title! ,
                        style: GoogleFonts.poppins(
                            fontSize:  16 ,
                            fontWeight: FontWeight.w500,
                            color: appCtrl.isTheme ?  appCtrl.appTheme.white : appCtrl.appTheme.textColor)),
                    if(dash.isDisplay)
                      Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            SvgPicture.asset(svgAssets.user,colorFilter: ColorFilter.mode( appCtrl.isTheme
                                ? appCtrl.appTheme.whiteColor
                                : appCtrl.appTheme.primary, BlendMode.srcIn),),
                            const HSpace(Sizes.s2),
                            Text(count ?? "0",
